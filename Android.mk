...
LOCAL_SRC_FILES := proprietary/etc/qdcm_calib_data_otm1901a_1080p_video_DJ_otp.xml
...
include $(CLEAR_VARS)
LOCAL_MODULE := qdcm_calib_data_r63350_1080p_video_Tianma
LOCAL_MODULE_OWNER := cmdc
LOCAL_SRC_FILES := proprietary/etc/qdcm_calib_data_r63350_1080p_video_Tianma.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_SUFFIX := .xml
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_OWNER := cmdc
LOCAL_SRC_FILES := proprietary/vendor/lib/libsdm-disp-apis.so
LOCAL_MULTILIB := 32
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
